...
function editDegree(task1){
    let degree= Number(prompt('enter new degree'))
    students[task1].degree = degree
    showStudents()
}
function getGrade(task1){
    if (students[task1].degree>= 90) return 'A'
    else if (students[task1].degree >= 80) return 'B'
    else if (students[task1].degree >= 70) return 'C'
    else if (students[task1].degree >= 60) return 'D'
    else return 'F'
}
function deleteStudent(task1){
    students.splice(task1,1)
    showStudents()
}
